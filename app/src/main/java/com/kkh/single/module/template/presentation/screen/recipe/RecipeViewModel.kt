...
class RecipeViewModel @Inject constructor(
    ...
    fun requestCreateVeganMenu(){
        viewModelScope.launch(Dispatchers.IO) {
            // TODO: Implement the logic to create a vegan menu
            val request = MemberIdRequest(userId.await())
            remoteDataSource.requestCreateMemberInfo(request)
        }
    }
